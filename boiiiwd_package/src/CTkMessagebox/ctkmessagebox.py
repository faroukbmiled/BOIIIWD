...
Author: Akash Bora
Version: 2.5
Modified for BOIIIWD Linux - fixed oldy/oldx race condition
"""
...
class CTkMessagebox(customtkinter.CTkToplevel):
    ...
    def __init__(self,
        ...
        # Initialize drag coordinates to prevent AttributeError race condition
        self.oldx = 0
        self.oldy = 0
    ...
    def move_window(self, event):
        # Defensive check in case move_window is called before oldxyset
